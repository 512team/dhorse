...
public class ProjectPO extends BasePO {
	...
	private ProjectExtendPO projectExtendPO;
	...
	public <T extends ProjectExtendPO> T getProjectExtendPO() {
		return (T) projectExtendPO;
	}

	public void setProjectExtendPO(ProjectExtendPO projectExtendPO) {
		this.projectExtendPO = projectExtendPO;
	}
